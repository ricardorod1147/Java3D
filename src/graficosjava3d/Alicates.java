...
public class Alicates extends Applet{
    ...
    private BranchGroup crearEscenarioGrafico(){
        ...
        BoundingSphere fronteras = new BoundingSphere(new Point3d(0,0,0),300);
        TextureLoader archivo = new TextureLoader("src/images/alicatesimg.jpg",this);
    ...
    private BranchGroup modelarObjeto(){
        ...
        producto.addChild(cargarObjeto("src\\images\\alicates.obj"));
        
        Alpha alpha = new Alpha(-1,9000);//velocidad del movimiento del objeto
        
        Transform3D eje = new Transform3D();
        eje.setRotation(new AxisAngle4f(1.3f,8.0f,7.0f,8.0f));//ejes de rotacion
        RotationInterpolator girar = new RotationInterpolator(alpha,producto,eje,0.0f,(float) Math.PI*(6.0f));
        BoundingSphere fronteras = new BoundingSphere(new Point3d(0.0,0.0,0.0),100000.0);
    ...
    public static void main (String[] args){
        ...
        Frame ventana = new MainFrame(ejecutar,900,500);//tamaño de la ventana
    }
}
