...
public class Gamer extends Applet{
     private static final long serialVersionUID = 1L;
    
    public static void main(String[] args){
        if (args.length>=1)
            new MainFrame(new Gamer(args[0]),850,600);
        else
            new MainFrame(new Gamer(null),850,600);
    }
    ...
    public BranchGroup crearescenaG(String filename){
        ...
        objTrans.setTranslation(new Vector3d(0.0,0.1,0.3));//cordenadas de rotación
        ...
        ObjectFile file = new ObjectFile(flags,(float)(100.0*Math.PI/180.0));
    ...
    private TransformGroup dibujarfondo(){
        ...
        TextureLoader espacio = new TextureLoader("src/images/sillaGamer.jpg",this);
