...
public class Martillo extends Applet {
 ...
 setLayout(new BorderLayout());
     ...
     private BranchGroup crearEscenarioGrafico(){
        ...
        BoundingSphere fronteras = new BoundingSphere(new Point3d(0,0,0),20000);
        TextureLoader archivo = new TextureLoader("src/images/martillo.jpg",this);
    ...
    private BranchGroup modelarObjeto(){
        ...
        producto.addChild(cargarObjeto("src\\images\\Hammer.obj"));
        
        Alpha alpha = new Alpha(-1,10000);//Define la velocidad del objeto
        
        Transform3D eje = new Transform3D();
        eje.setRotation(new AxisAngle4f(5.3f,5.0f,5.0f,5.0f));
        RotationInterpolator girar = new RotationInterpolator(alpha,producto,eje,0.0f,(float) Math.PI*(3.0f));//velocidad de rotación
        BoundingSphere fronteras = new BoundingSphere(new Point3d(5.0,5.0,5.0),20000000.0);//Frontera del objeto
    ...
    public static void main (String[] args){
        Martillo ejecutar = new Martillo();
        Frame ventana = new MainFrame(ejecutar,930,500);
    }
}
