...
public class Planta extends Applet {
    private static final long serialVersionUID = 1L;
    
    public static void main(String[] args){
        if (args.length>=1)
            new MainFrame(new Planta(args[0]),850,600);
        else
            new MainFrame(new Planta(null),850,600);
    }
    
    public Planta (String filename){
        //se crea el universo
    ...
    BoundingBox limites = new BoundingBox(new Point3d(-100,-100,-100),new Point3d(500,500,500));
    ...
    public BranchGroup crearescenaG(String filename){
        ...
        //ambiente de luces
        Color3f luz1Color = new Color3f(0.0f,1.0f,0.0f);
        ...
        Color3f ambienteColor = new Color3f(0.0f,0.0f,0.0f);
        ...
        Alpha rotacionAlpha = new Alpha(-1,Alpha.INCREASING_ENABLE,0,0,9000,0,0,0,0,0);//velocidad de rotación
        ...
        objTrans.setTranslation(new Vector3d(0.3,0.0,0.0));//traslación del objeto
        objTrans.setScale(0.3);//tamaño y distancia del objeto
        ...
        try{
           s = file.load(filename == null ? "src\\images\\plant\\eb_house_plant_01.obj" : filename);
    ...
    private TransformGroup dibujarfondo(){
        ...
        TextureLoader espacio = new TextureLoader("src/images/planta.jpg",this);
